...
const botaoDelTodos = document.querySelector('.botao_del_todos')
...
botaoDelTodos.addEventListener('click', () => limpaLista())

paleta1.addEventListener('mousemove', () => definePaleta('seagreen'))
